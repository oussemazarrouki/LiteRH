...
// 25-level shadow array required by MUI (index 0 = none)
const shadowsArray = [
  'none',
...
// Shared button overrides applied to both themes
...
export const darkTheme = createTheme({
  palette: {
    ...
    success: { main: 'rgba(169, 223, 216)', contrastText: '#161821' },
    warning: { main: 'rgba(252, 184, 89)', contrastText: '#000000' },
    error: { main: 'rgba(242, 109, 91)', contrastText: '#ffffff' },
    info: { main: 'rgba(40, 174, 243)', contrastText: '#ffffff' },
    neutral: { main: 'rgba(242, 200, 237)', contrastText: '#000000' },
    highlight: { main: 'rgba(199, 162, 255)', contrastText: '#000000' },
  },
  typography: {
  ...
  components: {
    ...
    MuiCard: {
      styleOverrides: {
        root: { backgroundColor: '#21222c', color: '#E2E8F0' },
      },
    },
    MuiAppBar: {
      styleOverrides: {
        root: { backgroundColor: '#21222c' },
      },
    },
    MuiDialog: {
      styleOverrides: {
        paper: { backgroundColor: '#21222c', color: '#E2E8F0' },
      },
    },
    MuiTableCell: {
      styleOverrides: {
        root: { borderBottom: '1px solid #2d2e3a' },
        head: { backgroundColor: '#2a2b36', color: '#64748B', fontWeight: 600 },
      },
    },
    MuiTableRow: {
      styleOverrides: {
        root: { '&:hover': { backgroundColor: '#2a2b36' } },
      },
    },
    MuiCssBaseline: {
      styleOverrides: `
        ...
        .MuiFormLabel-root { color: #E2E8F0; }
      `,
    },
  },
});
...
export const whiteTheme = createTheme({
  palette: {
    ...
    success: { main: 'rgba(139, 193, 187, 0.9)', contrastText: '#ffffff' },
    warning: { main: 'rgba(242, 164, 59, 0.9)', contrastText: '#ffffff' },
    error: { main: 'rgba(222, 79, 61, 0.9)', contrastText: '#ffffff' },
    info: { main: 'rgba(20, 154, 223, 0.9)', contrastText: '#ffffff' },
    neutral: { main: 'rgba(222, 180, 217, 0.9)', contrastText: '#ffffff' },
    highlight: { main: 'rgba(179, 142, 235, 0.9)', contrastText: '#ffffff' },
  },
  typography: {
    fontFamily: '"Inter", "Roboto", "Helvetica", "Arial", sans-serif',
  },
  ...
  components: {
    ...
    MuiDialog: {
      styleOverrides: {
        paper: { backgroundColor: '#FFFFFF', color: '#1E293B' },
      },
    },
    MuiTableCell: {
      styleOverrides: {
        root: { borderBottom: '1px solid #E2E8F0' },
        head: { backgroundColor: '#F1F5F9', color: '#64748B', fontWeight: 600 },
      },
    },
    MuiTableRow: {
      styleOverrides: {
